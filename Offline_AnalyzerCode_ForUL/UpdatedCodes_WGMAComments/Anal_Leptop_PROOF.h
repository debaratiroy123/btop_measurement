...
class Anal_Leptop_PROOF : public TSelector {
 ...
 double ptbins[noptbins+1] = {395, 430, 468,
  ...
  static const int nobshist = 45;
    ...
    double obs_up[nobshist] = {3100,2.5,300,1,1,300,2.5,1,1,1,1,1,1,1,1.5,1.5,1.5,1.5,5,5,5,5,5,3100,2.5,300,1,1,300,2.5,1,1,1,1,1,1,1,1.5,1.5,1.5,1.5,5,5,5,5};
    ...
    //TString weightfile1 = TString("TMVAClassification_BDTG_elIDvar_Jan2021Corr_TTbarUL18.weights.xml");  
