...
Bool_t Anal_Leptop_PROOF::Process(Long64_t entry)
{
  ...
  itrig_pass = ((hlt_Mu37Ele27==1)||(hlt_Mu27Ele37==1)||(hlt_Mu37TkMu27==1)||(hlt_DoubleEle25==1)||(hlt_Mu50==1)||(hlt_Ele50_PFJet165));
...
#ifdef E_MU_TTBar
  itrigemu_pass = ((hlt_Mu37Ele27==1)||(hlt_Mu27Ele37==1)||(hlt_Mu50==1)||(hlt_Ele50_PFJet165==1));
...
#elif defined(E_E_TTBar)
  itrigee_pass = ((hlt_DoubleEle25==1)||(hlt_Ele50_PFJet165==1));
  if(!itrigee_pass) return kFALSE;
#elif defined(MU_MU_TTBar)
  itrigmumu_pass = ((hlt_Mu37TkMu27==1)||(hlt_Mu50==1));
  ...
  if (extra_ak4j>=1) {
    ...
    for(unsigned ijet=2; ijet<Jets.size(); ijet++){
    ...
    if (leadptcand>=2) {
      ...
      if (delta2R(Jets[leadptcand].eta,Jets[leadptcand].phi,l1.Eta(),l1.Phi())<delta2R(Jets[leadptcand].eta,Jets[leadptcand].phi,l2.Eta(),l2.Phi())) rat_extra_ak4jpt_lpt = Jets[leadptcand].pt/l1.Pt();
      else rat_extra_ak4jpt_lpt = Jets[leadptcand].pt/l2.Pt();
    }
  }
  ...
  if (nbjetAK4>0) hist_obs[20]->Fill(delta2R(LJets[0].eta,LJets[0].phi,bjv[0].Eta(),bjv[0].Phi()),weight);
  ...
  if (npfjetAK8>1) { 
    ...
    if (nbjetAK4>0) hist_obs[43]->Fill(delta2R(LJets[1].eta,LJets[1].phi,bjv[0].Eta(),bjv[0].Phi()),weight);
    if (nbjetAK4>1) hist_obs[44]->Fill(delta2R(LJets[1].eta,LJets[1].phi,bjv[1].Eta(),bjv[1].Phi()),weight);
  }
